        ...
        <div className="grid md:grid-cols-2 gap-8 lg:gap-12">
          ...
          <div className="space-y-6">
            <div className="terminal-border bg-black/40 backdrop-blur-sm p-6">
              <div className="space-y-4 text-terminal-green/80 leading-relaxed">
            ...
            <div className="terminal-border bg-black/40 backdrop-blur-sm p-6">
              <div className="text-terminal-cyan/70 text-sm mb-3 font-mono">
                $ echo $PHILOSOPHY
              </div>
              <blockquote className="text-terminal-green/80 italic border-l-2 border-terminal-purple pl-4">
          ...
          <div className="space-y-6">
            {features.map((feature, index) => {
              ...
              return (
                <div
                  key={index}
                  className="terminal-border bg-black/40 backdrop-blur-sm p-6 group hover:bg-black/60 transition-all duration-300 hover:shadow-glow"
                ...
                >
                  ...
                  <div className="mt-4 flex items-center gap-2 text-terminal-cyan/50 text-xs">
